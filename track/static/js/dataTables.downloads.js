...
$.fn.dataTable.Download = function ( inst ) {
  ...
  api.on('draw', function () {
    ...
    var elem = "" +
      "<a id='csvdownload' onClick=\"gtag('event', 'download', { event_category: 'Download / Télécharger', event_action: 'Download / Télécharger CSV'});\" class =\"text-https-blue hover:text-black font-bold\" href=\"" + csv + "\" download>" +
        text +
      "</a>";
